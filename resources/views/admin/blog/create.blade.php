                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="author_name" class="form-control"
                                                       placeholder="Please Enter Author Name" value="{{ old('author_name') }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="short_description" id="short_description" cols="12"
                                                          class="form-control" style="height: 175px;"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" id="description" cols="12"
                                                          class="form-control" style="height: 279px;"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
